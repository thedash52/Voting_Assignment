...
namespace votingFrontend.Services
{
    internal class RestService
    {
        ...
        {
            string url = resource.GetString("BaseUrl") + "/api/VoteData/GetElectoratesAsync";
        ...
        {
            string url = resource.GetString("BaseUrl") + "/api/VoteData/GetCandidatesAsync";
        ...
        {
            string url = resource.GetString("BaseUrl") + "/api/UserContoller/SaveVoteAsync";
            string contentType = resource.GetString("ContentType");
        ...
        {
            string url = resource.GetString("BaseUrl") + "/api/VoteData/GetPartiesAsync";
        ...
        {
            string url = resource.GetString("BaseUrl") + "/api/VoteData/GetReferendumAsync";
